...
_G.packer_plugins = {
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim",
  ...
  ["panda.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/panda.nvim",
    url = "https://github.com/thewinger/panda.nvim"
  },
  playground = {
    loaded = true,
